...
def Function(msg, cmd, ln):
		if "botadded" in cmd[0]:
			...
			return msg_replace_(msg, lang('newGroup', ln))		
		elif "botremoved" in cmd[0]:
			sendAdmin(text=lang('alertbotremoved', 'service', sudo=True).format(json.dumps(msg['chat'], indent=1), json.dumps(msg['adder'], indent=1)), parse_mode="HTML")
